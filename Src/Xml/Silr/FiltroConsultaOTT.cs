...
{
    /// <summary>
    /// Elemento de detalle para las Operaciones Trascendencia Tributaria.
    /// </summary>
    [Serializable]
    public class FiltroConsultaOTT
    {
        ...
        /// </summary>
        public ClavePaginacionOTT ClavePaginacion { get; set; }
   

        /// <summary>
        /// Constructor clase RegistroLRFacturasEmitidas.
        /// </summary>
        public FiltroConsultaOTT()
        {
