...
namespace EasySII.Xml.Silr
{
    ...
    /// </summary>
    [Serializable]
    public class FiltroConsultaInformadasCliPro
    {
        ...
        /// fecha de expedición).
        /// </summary>
        [XmlElement("PeriodoImputacion", Order = 2, Namespace = Settings.NamespaceSii)]
        public PeriodoImputacion PeriodoImputacion { get; set; }

        /// <summary>
        /// Datos cliente.
        /// </summary>
        [XmlElement("Cliente", Order = 3, Namespace = Settings.NamespaceSiiLRQ)]
        public Contraparte Cliente { get; set; }

        /// <summary>
        /// Datos proveedor.
        /// </summary>
        [XmlElement("Proveedor", Order = 4, Namespace = Settings.NamespaceSiiLRQ)]
        ...
        /// </summary>
        [XmlElement("NumSerieFacturaEmisor", Order = 5, Namespace = Settings.NamespaceSiiLRQ)]
        ...
        /// </summary>
        [XmlElement("ClavePaginacion", Order = 9)]
        public ClavePaginacion ClavePaginacion { get; set; }


        /// <summary>
        /// Constructor clase FiltroConsultaInformadasCliPro.
        /// </summary>
        public FiltroConsultaInformadasCliPro()
        {    
            PeriodoImputacion = new PeriodoImputacion();
        }
    }
}
