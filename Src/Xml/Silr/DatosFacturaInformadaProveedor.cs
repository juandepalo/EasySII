...
namespace EasySII.Xml.Silr
{
    ...
    /// </summary>
    [Serializable]
    public class DatosFacturaInformadaProveedor
    {
        ...
        /// S/N.
        /// </summary>
        [XmlElement("EmitidaPorTercerosODestinatario", Namespace = Settings.NamespaceSiiRQ)]
        ...
        public TipoDesgloseFactInfProveedor TipoDesglose { get; set; }
