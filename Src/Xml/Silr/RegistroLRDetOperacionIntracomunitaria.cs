...
namespace EasySII.Xml.Silr
{
    ...
    /// </summary>
    [Serializable]
    public class RegistroLRDetOperacionIntracomunitaria
    {
        ...
        /// </summary>
        [XmlElement("OperacionIntracomunitaria", Namespace = Settings.NamespaceSiiLR)]
        public OperacionIntracomunitaria OperacionIntracomunitaria { get; set; }
        ...
        public RegistroLRDetOperacionIntracomunitaria()
        {
            ...
            OperacionIntracomunitaria = new OperacionIntracomunitaria();
        }
    }
}