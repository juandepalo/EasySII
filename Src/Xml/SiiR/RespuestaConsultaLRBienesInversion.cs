...
namespace EasySII.Xml.SiiR
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot("RespuestaConsultaLRBienesInversion")]
    public class RespuestaConsultaLRBienesInversion
    {
        ...
        /// </summary>
        [XmlElement("RegistroRespuestaConsultaLRBienesInversion", Namespace = Settings.NamespaceSiiRQ)]
        public List<RegistroRCLRBienesInversion> RegistroRCLRBienesInversion { get; set; }
