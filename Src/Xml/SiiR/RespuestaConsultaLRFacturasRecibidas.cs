...
namespace EasySII.Xml.SiiR
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot("RespuestaConsultaLRFacturasRecibidas")]
    public class RespuestaConsultaLRFacturasRecibidas
    {
        ...
        /// </summary>
        [XmlElement("RegistroRespuestaConsultaLRFacturasRecibidas", Namespace = Settings.NamespaceSiiRQ)]
        public List<RegistroRCLRFacturasRecibidas> RegistroRCLRFacturasRecibidas { get; set; }
