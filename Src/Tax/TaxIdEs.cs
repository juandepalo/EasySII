                    ...
                    switch (this.TaxIdentificationType)
                    {
                        case TaxIdEsTypes.DNI:
                            if (!rgxTaxIdDniIndividual.IsMatch(TaxCode))
                                throw new Exception("TaxIdEs.DNI don't match the pattern: " + 
                        ...
                        case TaxIdEsTypes.NIF:
                            switch (this.PersonType)
                            {
                                ...
                                case TaxIdEsPersonTypeCode.LegalEntity:
                                    ...
                                    break;
                                default:
                                    throw new Exception("Unknown TaxIdEsPersonTypeCode.");
                            }
                            break;
                        default:
                            throw new Exception("Unknown TaxIdentificationType.");
                    }
