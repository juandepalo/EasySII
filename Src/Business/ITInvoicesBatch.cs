...
{
    /// <summary>
    /// Lote de Operaciones Intracomunitarias.
    /// </summary>
    public class ITInvoicesBatch
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor clase ITInvoicesBatch.
        /// </summary>
        public ITInvoicesBatch()
        {
        ...
        /// </summary>
        /// <param name="suministroLRDetOperacionIntracomunitaria">Objeto de serialización xml para
        /// suministro de facturas emitidas.</param>
        public ITInvoicesBatch(SuministroLRDetOperacionIntracomunitaria suministroLRDetOperacionIntracomunitaria)
        {
            ITInvoices = new List<ITInvoice>();
            ...
            if (!Enum.TryParse<CommunicationType>(
                suministroLRDetOperacionIntracomunitaria.Cabecera.TipoComunicacion, out communicationType))
                throw new InvalidOperationException($"Unknown comunication type {suministroLRDetOperacionIntracomunitaria.Cabecera.TipoComunicacion}");

            CommunicationType = communicationType;

            Titular = new Party()
            {
                TaxIdentificationNumber = suministroLRDetOperacionIntracomunitaria.Cabecera.Titular.NIF,
                PartyName = suministroLRDetOperacionIntracomunitaria.Cabecera.Titular.NombreRazon
            };

            foreach (var invoice in
                suministroLRDetOperacionIntracomunitaria.RegistroLRDetOperacionIntracomunitaria)
                ITInvoices.Add(new ITInvoice(invoice));
        ...
        public string GetSentFileName()
        {
            ...
            return GetFileName("LROI.SENT.{0}.{1}.{2}.xml");
        ...
        public string GetReceivedFileName()
        {
            ...
            return GetFileName("LROI.RECEIVED.{0}.{1}.{2}.xml");
            ...
            string numLastInvoiceNumber, string taxIdentificationNumber)
        {
            ...
            string template = "LROI.SENT.{0}.{1}.{2}.xml";
            ...
            string numLastInvoiceNumber, string taxIdentificationNumber)
        {
            ...
            string template = "LROI.RECEIVED.{0}.{1}.{2}.xml";
